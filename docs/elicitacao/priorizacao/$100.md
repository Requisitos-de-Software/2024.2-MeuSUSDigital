...
<div align="center">
    <p><strong>Tabela 4 – Requisitos ordenados mediante a priorização</strong></p>
</div>

<center>

| Posição | Tipo  | Descrição | Rastreabilidade | Valor ($) |
| :-----: | :---: | --------- | --------------- | :-------: |
| 1       | RF3   | O aplicativo deve disponibilizar ao usuário o acesso à sua Carteira Nacional de Vacinação Digital | OBS3 | $5,00 |
| 1       | RF5   | O aplicativo deve permitir que o usuário exporte/baixe o certificado referente à sua Carteira Nacional de Vacinação Digital | OBS5 | $5,00 |
| 1       | RF1   | O sistema deve permitir que o paciente realize login por meio de uma conta Gov.br | OBS1 | $5,00 |
| 4       | RF28  | O aplicativo deve possibilitar o agendamento de consultas médicas ou exames de saúde | OBS28 | $4,00 |
| 5       | RF9   | O aplicativo deve permitir a visualização dos exames laboratoriais realizados | OBS9 | $3,00 |
| 5       | RF13  | O aplicativo deve disponibilizar ao usuário o acesso ao seu histórico de medicamentos recebidos | OBS13 | $3,00 |
| 5       | RF16  | O aplicativo deve fornecer ao usuário, em adesão ao Programa Farmácia Popular, a opção de autorizar ou não a retirada de medicamentos em seu CPF | OBS16 | $3,00 |
| 5       | RF17  | O aplicativo deve permitir que o usuário possa verificar os medicamentos recebidos pelo Programa Farmácia Popular | OBS17 | $3,00 |
| 5       | RF20  | O aplicativo deve permitir que o usuário exporte/baixe o documento referente à autorização de participação do Programa Dignidade Menstrual | OBS20 | $3,00 |
| 10      | RF6   | O aplicativo deve disponibilizar ao usuário o acesso ao seu histórico de vacinas | OBS6 | $2,00 |
| 10      | RF7   | O aplicativo deve disponibilizar ao usuário o acesso aos detalhes de cada vacina | OBS7 | $2,00 |
| 10      | RF10  | O aplicativo deve permitir a visualização dos resultados e demais informações a respeito dos exames laboratoriais realizados | OBS10 | $2,00 |
| 10      | RF11  | O aplicativo deve permitir a exportação/download do documento contendo o resultado e demais informações a respeito de cada exame laboratorial realizado | OBS11 | $2,00 |
| 10      | RF14  | O aplicativo deve permitir que o usuário adicione um medicamento recebido por meio de programas de dispensação do Governo Federal através de um mecanismo de busca | OBS14 | $2,00 |
| 10      | RF19  | Caso o usuário atenda aos critérios do Programa, o aplicativo deve permitir que o usuário emita uma autorização para participar do Programa Dignidade Menstrual | OBS19 | $2,00 |
| 10      | RF24  | O aplicativo deve oferecer opções de estabelecimentos de saúde a fim de que o usuário possa identificar àqueles próximos à sua localização, de acordo com o tipo de serviço desejado | OBS24 | $2,00 |
| 10      | RF25  | O aplicativo deve permitir que o usuário possa identificar os estabelecimentos de saúde recentes vinculados a ele | OBS25 | $2,00 |
| 10      | RF27  | O aplicativo deve exibir as consultas médicas ou exames de saúde do usuário | OBS27 | $2,00 |
| 10      | RF35  | O aplicativo deve exibir todos os registros de saúde do usuário | OBS35 | $2,00 |
| 10      | RNF2  | O aplicativo deve exibir informações de ajuda de maneira acessível e compreensível para todos os usuários, incluindo pessoas com deficiência visual ou auditiva | OBS46 | $2,00 |
| 10      | RNF9  | Os resultados de exames laboratoriais devem ser apresentados em formato padronizado e visualmente acessível | OBS53 | $2,00 |
| 10      | RNF12 | O aplicativo deve exibir informações sobre medicamentos em uma interface responsiva e acessível | OBS56 | $2,00 |
| 10      | RNF26 | As informações sobre consultas médicas ou exames devem ser exibidas com visualização amigável e intuitiva | OBS70 | $2,00 |
| 26      | RF2   | O aplicativo deve permitir que o usuário obtenha ajuda informativa a respeito da seção de Vacinas | OBS2 | $1,00 |
| 26      | RF4   | O aplicativo deve permitir que o usuário selecione o idioma do certificado referente à sua Carteira Nacional de Vacinação Digital | OBS4 | $1,00 |
| 26      | RF8   | O aplicativo deve permitir que o usuário obtenha ajuda informativa a respeito da seção de Exames | OBS8 | $1,00 |
| 26      | RF12  | O aplicativo deve permitir que o usuário obtenha ajuda informativa a respeito da seção de Medicamentos | OBS12 | $1,00 |
| 26      | RF15  | O aplicativo deve permitir que o usuário possa realizar a busca por um medicamento através do nome e dosagem do mesmo | OBS15 | $1,00 |
| 26      | RF18  | O aplicativo deve permitir que o usuário obtenha ajuda informativa a respeito da seção de Dignidade Menstrual | OBS18 | $1,00 |
| 26      | RF21  | O aplicativo deve permitir que o usuário obtenha ajuda informativa a respeito da seção de Rede de Saúde | OBS21 | $1,00 |
| 26      | RF22  | O aplicativo deve pedir permissão de acesso à localização do dispositivo do usuário | OBS22 | $1,00 |
| 26      | RF26  | O aplicativo deve permitir que o usuário obtenha ajuda informativa a respeito da seção de Agendamentos | OBS26 | $1,00 |
...
| 94      | RNF13 | O histórico de medicamentos deve ser armazenado em servidores redundantes para garantir alta disponibilidade | OBS57 | $0,00 |
