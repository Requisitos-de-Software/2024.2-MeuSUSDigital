# Protótipo de Alta Fidelidade - Exportar Receitas Médicas
...
| :----: | --------- | --------- | :--------------: | ----------- | :-------------: |
| `1.0`  | Criação do documento do protótipo de alta fidelidade sobre a funcionalidade de exportar receitas médicas. | [Matheus Henrick](https://github.com/MatheusHenrickSantos) | 03/02/2025 |  |  |
