...
| :----: | --------- | --------- | :--------------: | ----------- | :-------------: |
| `1.0`  | Criação do Documento | [Emivalto Júnior](https://github.com/EmivaltoJrr) | 05/12/2024 | [Artur Ricardo](https://github.com/algorithmorphic) | 08/12/2024 |
