...
??? note "Tabela 4 – Modelagem de Requisitos (Ágil)"
    ...
    | Inspecionar a entrega da apresentação da Etapa 4 do projeto do Grupo 5 | Início: 18/12<br>Fim: 18/12 | [Artur Ricardo](https://github.com/algorithmorphic), [Emivalto junior](https://github.com/EmivaltoJrr), [João Pedro](https://github.com/JoosPerro), [Matheus Henrick](https://github.com/MatheusHenrickSantos) e [Pedro Lopes](https://github.com/pLopess) | Início: 18/12<br>Fim: 18/12 | [Artur Ricardo](https://github.com/algorithmorphic), [Emivalto junior](https://github.com/EmivaltoJrr), [João Pedro](https://github.com/JoosPerro), [Matheus Henrick](https://github.com/MatheusHenrickSantos) e [Pedro Lopes](https://github.com/pLopess) |
    | Correção pós entrega/apresentação da Etapa 4 do projeto | Início: 19/12<br>Fim: 16/01 | [Artur Ricardo](https://github.com/algorithmorphic) | Início: 19/12<br>Fim: 16/01 | [Artur Ricardo](https://github.com/algorithmorphic), [Emivalto junior](https://github.com/EmivaltoJrr), [João Pedro](https://github.com/JoosPerro), [Matheus Henrick](https://github.com/MatheusHenrickSantos) e [Pedro Lopes](https://github.com/pLopess) |
...
??? note "Tabela 5 – Análise de Requisitos"
    ...
    | Atividade | Período de desenvolvimento | Responsável(eis) | Período de revisionamento | Revisor(es) |
    | --------- | -------------------------- | ---------------- | ------------------------- | ----------- |
    | Confecção do documento referente à reunião (ou às reuniões) realizadas durante a Etapa 5 | Início: 28/01<br>Fim: 29/01 | [João Pedro](https://github.com/JoosPerro) | Início: 03/02<br>Fim: 03/02 | [Artur Ricardo](https://github.com/algorithmorphic) |
    ...
    | Confecção do documento referente ao protótipo de alta fidelidade do RF60 | Início: 31/01<br>Fim: 03/02 | [Artur Ricardo](https://github.com/algorithmorphic) | Início: 03/02<br>Fim: 03/02 | [Emivalto junior](https://github.com/EmivaltoJrr) |
    | Confecção do documento referente ao protótipo de alta fidelidade do RF62 | Início: 31/01<br>Fim: 03/02 | [Artur Ricardo](https://github.com/algorithmorphic) | Início: 03/02<br>Fim: 03/02 | [Emivalto junior](https://github.com/EmivaltoJrr) |
    | Confecção do documento referente ao protótipo de alta fidelidade do RF67 | Início: 31/01<br>Fim: 03/02 | [Artur Ricardo](https://github.com/algorithmorphic) | Início: 03/02<br>Fim: 03/02 | [Emivalto junior](https://github.com/EmivaltoJrr) |
    | Confecção do documento referente ao protótipo de alta fidelidade do RF68 | Início: 31/01<br>Fim: 03/02 | [Artur Ricardo](https://github.com/algorithmorphic) | Início: 03/02<br>Fim: 03/02 | [Matheus Henrick](https://github.com/MatheusHenrickSantos) |
    | Confecção do documento referente ao protótipo de alta fidelidade do RF58 | Início: <br>Fim: | [Emivalto junior](https://github.com/EmivaltoJrr) | Início: 03/02<br>Fim: 03/02 | [Matheus Henrick](https://github.com/MatheusHenrickSantos) |
    | Confecção do documento referente ao protótipo de alta fidelidade do RF66 | Início: <br>Fim: | [Emivalto junior](https://github.com/EmivaltoJrr) | Início: 03/02<br>Fim: 03/02 | [Matheus Henrick](https://github.com/MatheusHenrickSantos) |
    | Confecção do documento referente ao protótipo de alta fidelidade do RF75 | Início: <br>Fim: | [Emivalto junior](https://github.com/EmivaltoJrr) | Início: 03/02<br>Fim: 03/02 | [Matheus Henrick](https://github.com/MatheusHenrickSantos) |
    ...
    | Confecção do documento referente ao protótipo de alta fidelidade do RF71 | Início: 31/01<br>Fim: 03/02 | [Matheus Henrick](https://github.com/MatheusHenrickSantos) | Início: 03/02<br>Fim: 03/02 | [Artur Ricardo](https://github.com/algorithmorphic) |
    | Confecção do documento referente ao protótipo de alta fidelidade do RF74 | Início: 31/01<br>Fim: 03/02 | [Matheus Henrick](https://github.com/MatheusHenrickSantos) | Início: 03/02<br>Fim: 03/02 | [Artur Ricardo](https://github.com/algorithmorphic) |
    ...
    | Gravar a validação dos protótipos de alta fidelidade produzidos | Início: 03/02<br>Fim: 03/02 | [Artur Ricardo](https://github.com/algorithmorphic) | Início: <br>Fim: |  |
...
??? note "Tabela 7 – Entrega da apresentação do projeto final"
    ...
    | Atividade | Período de desenvolvimento | Responsável(eis) | Período de revisionamento | Revisor(es) |
    | --------- | -------------------------- | ---------------- | ------------------------- | ----------- |
    | Criação do documento referente à prorização de requisitos utilizando a técnica In or Out (Etapa 2 - Elicitação – Técnicas e Priorização) | Início: 10/02<br>Fim: 10/02 | [Artur Ricardo](https://github.com/algorithmorphic) | Início: <br>Fim: |  |
    ...
    | Produzir documento contendo uma tabela sintetizando quais artefatos foram criados no projeto em cada etapa do projeto. | Início: 10/02 <br>Fim: 10/02 | [Pedro Lopes](https://github.com/pLopess) | Início: <br>Fim: |  |
...
| `2.4`  | Atualização de dados da tabela Etapa Final | [Pedro Lopes](https://github.com/pLopess) | 10/02/2025 | [Emivalto junior](https://github.com/EmivaltoJrr) | 10/02/2025 |
