...
O objetivo deste documento é relatar os resultados da avaliação da Entrega 6 do projeto do [Grupo 5](https://github.com/Requisitos-de-Software/2024.2-TesouroDireto), em forma de inspeção. Será verificado se os artefatos produzidos nesta quarta etapa cumprem com as condições e padrões propostos pelo Grupo 4. É importante citar que essa verificação não tem como intuito diminuir os membros responsáveis por cada artefato ou seu trabalho, apenas aplicar os conceitos de verificação.

## Inspeção

A inspeção foi baseada na [lista de verificação da Entrega 6](../../lista_verif/entrega6.md) produzida com a ajuda do professor e dos integrantes do Grupo 4.
...
<table border="1">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Não. No documento referente à Matriz de Rastreabilidade há uma tabela sem legenda e fonte.</td>
      <td>André Barros</td>
      <td>17/12/2024 22:00</td>
      <td>-</td>
    </tr>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Sim. Só faltou o nível de cada elo na tabela.</td>
      <td>Matheus Henrick</td>
      <td>17/12/2024 22:00</td>
      <td>1.4</td>
    </tr>
