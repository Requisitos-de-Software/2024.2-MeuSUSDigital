...
<tr>
  <td>40</td>
  <td>O backlog foi desenvolvido/ validado com um Product Owner?</td>
  <td>Pedro Lopes</td>
</tr>
<tr>
  <td>41</td>
  <td> As Histórias de Usuários são focadas em descrever “o que” é o item?</td>
  <td>Pedro Lopes</td>
</tr>
<tr>
  <td>42</td>
  <td>As Histórias de Usuário são pequenas, detalhadas e específicas?</td>
  <td>Pedro Lopes</td>
</tr>
<tr>
  <td>43</td>
  <td>As histórias de usuário são uma forma ágil de documentar requisitos do ponto de vista do usuário, seguindo geralmente o formato "Como [papel], eu quero [função] para que [benefício]", e são mantidas em um backlog priorizado?</td>
  <td>Emivalto</td>
</tr>
<tr>
  <td>44</td>
  <td>O Product Backlog é uma lista priorizada de todas as funcionalidades desejadas para o produto, sendo que os itens no topo do backlog devem ser mais detalhados e prontos para implementação do que os itens mais abaixo?</td>
  <td>Emivalto</td>
</tr>
<tr>
  <td>45</td>
  <td>As histórias de usuário no backlog devem ser independentes, negociáveis, valiosas, estimáveis, pequenas e testáveis, seguindo o acrônimo INVEST (Independent, Negotiable, Valuable, Estimable, Small, Testable)?</td>
  <td>Emivalto</td>
</tr>
<tr>
  <td>46</td>
  <td>Foram especificados requisitos por meio de histórias do usuário?</td>
  <td>Artur</td>
</tr>
<tr>
  <td>47</td>
  <td>Foram especificados requisitos não funcionais por meio de histórias do usuário?</td>
  <td>Artur</td>
</tr>
<tr>
  <td>48</td>
  <td>As histórias do usuário criadas responderam às três perguntas: Quem se beneficia? O que se quer? Qual é o benefício?</td>
  <td>Artur</td>
</tr>
<tr>
  <td>49</td>
  <td>Cada História de Usuário tem um enunciado na forma “Como um [papel], eu desejo [funcionalidade], para que [razão para o uso da funcionalidade]”?</td>
  <td>João Pedro</td>
</tr>
<tr>
  <td>50</td>
  <td>As Histórias de Usuário estão organizadas em um Backlog?</td>
  <td>João Pedro</td>
</tr>
<tr>
  <td>51</td>
  <td>Os Backlog Items (as Histórias de Usuário) apresentam alguma forma de priorização?</td>
  <td>João Pedro</td>
</tr>
<tr>
...
<tr>
  ...
  <td>Emivalto</td>
    ...
    <tr>
      <td>58</td>
      <td>A rastreabilidade foi implementada por meio de ferramentas de mapeamento de grafos ou matrizes bidimensionais?<a id="anchor_58" href="#REF58"><sup>fonte</sup></a></td>
      <td>Artur</td>
    </tr>
    <tr>
      <td>59</td>
      <td>Os elos (ou vínculos) foram identificados e documentados durante a rastreabilidade dos requisitos?<a id="anchor_59" href="#REF59"><sup>fonte</sup></a></td>
      <td>Artur</td>
    </tr>
    <tr>
      <td>60</td>
      <td>Os elos de rastreabilidade permitem verificar se um requisito foi implementado no sistema e identificar se a propriedade do sistema implementa o requisito especificado?<a id="anchor_60" href="#REF60"><sup>fonte</sup></a></td>
      <td>Emivalto</td>
    </tr>
    <tr>
      <td>61</td>
      <td>Os elos de rastreabilidade auxiliam na análise de impacto durante o gerenciamento de mudanças, permitindo identificar os artefatos de requisitos que precisam ser alterados quando seus requisitos subjacentes sofrem uma mudança?<a id="anchor_61" href="#REF61"><sup>fonte</sup></a></td>
      <td>Emivalto</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>62</td>
      <td>Considerando os níveis dos Elos de Toranzo, existem elos descritos pelo grupo que contemplam o nível ambiental (contexto onde a organização está inserida)?<a id="anchor_62" href="#REF62"><sup>fonte</sup></a></td>
      <td>Pedro</td>
    </tr>
    <tr>
      <td>63</td>
      <td>Considerando os Principais tipos de Elos de Toranzo, elos do tipo “Recurso” (classe de origem possui dependência de recurso com a classe de destino) foram feitos?<a id="anchor_63" href="#REF63"><sup>fonte</sup></a></td>
      <td>Pedro</td>
    </tr>
    <tr>
      <td>64</td>
      <td>Foram desenvolvidos elos do tipo “Satisfação” (classe de origem com dependência de satisfação com a classe destino)?<a id="anchor_64" href="#REF64"><sup>fonte</sup></a></td>
      <td>Pedro</td>
    </tr>
    <tr>
      <td>65</td>
      <td>Os elos de rastreabilidade permitem verificar se um requisito foi implementado no sistema e identificar se a propriedade do sistema implementa o requisito especificado?<a id="anchor_65" href="#REF65"><sup>fonte</sup></a></td>
      <td>Emivalto</td>
    </tr>
    <tr>
      <td>66</td>
      <td>Os elos de rastreabilidade auxiliam na análise de impacto durante o gerenciamento de mudanças, permitindo identificar os artefatos de requisitos que precisam ser alterados quando seus requisitos subjacentes sofrem uma mudança?<a id="anchor_66" href="#REF66"><sup>fonte</sup></a></td>
      <td>Emivalto</td>
    </tr>
    <tr>
      <td>67</td>
      <td>Os elos de rastreabilidade podem ser representados através de referências textuais simples, hyperlinks, matrizes de rastreabilidade e grafos de rastreabilidade?<a id="anchor_67" href="#REF67"><sup>fonte</sup></a></td>
      <td>Emivalto</td>
    </tr>
    <tr>
      <td>68</td>
      <td>A classificação das informações rastreadas no projeto contempla os quatro níveis: ambiental, organizacional, gerencial e de desenvolvimento?<a id="anchor_68" href="#REF68"><sup>fonte</sup></a></td>
      <td>Artur</td>
    </tr>
    <tr>
      <td>69</td>
      <td>O modelo de rastreamento inclui instâncias de relacionamentos como 'satisfação', 'recurso', 'responsabilidade', ‘representação’, ‘alocado’, ‘agregação’ e ‘generalização’ para documentar as dependências entre os artefatos?<a id="anchor_69" href="#REF69"><sup>fonte</sup></a></td>
      <td>Artur</td>
    </tr>
    <tr>
      <td>70</td>
      <td>O modelo de rastreamento utiliza uma matriz para representar e validar os relacionamentos entre as classes de informação?<a id="anchor_70" href="#REF70"><sup>fonte</sup></a></td>
      <td>Artur</td>
    </tr>
  </tbody>
</table>
